"""
Django settings for es4c_manager project.
...
ROOT_URLCONF = "es4c_manager.urls"
...
WSGI_APPLICATION = "es4c_manager.wsgi.application"
...
# Custom settings
AUTH_USER_MODEL = "main.CollegeUser"
LOGIN_URL = '/login/'


ALLOWED_EMAIL_DOMAINS = os.environ['ES4C_MANAGER_ALLOWED_EMAIL_DOMAINS'].split(',')
...
CSRF_TRUSTED_ORIGINS = ['https://' + HOST_FQDN]
